  ...
  return (
    <div className="bg-surface text-on-surface font-body-md min-h-screen pb-[100px] md:bg-surface-container-low">
      ...
      <main className="max-w-[600px] mx-auto pt-[72px] md:pt-xl px-md flex flex-col gap-xl">
        {/* User Profile Header */}
        <section onClick={() => tip('用户：美食探索家，手机：138****5678')} className="flex items-center gap-md p-md rounded-xl bg-surface-container-lowest shadow-[0_4px_16px_rgba(171,53,0,0.04)] cursor-pointer active:scale-[0.98] transition-transform">
        ...
        <section className="grid grid-cols-3 gap-sm">
          <button onClick={() => tip('账户余额可用于模拟支付，演示环境不产生真实扣款。')} className="bg-surface-container-lowest p-md rounded-xl shadow-[0_4px_12px_rgba(171,53,0,0.03)] flex flex-col items-center justify-center text-center active:bg-surface-variant transition-colors cursor-pointer">
          ...
          <button onClick={goCoupons} className="bg-surface-container-lowest p-md rounded-xl shadow-[0_4px_12px_rgba(171,53,0,0.03)] flex flex-col items-center justify-center text-center active:bg-surface-variant transition-colors cursor-pointer relative overflow-hidden">
          ...
          <button onClick={() => tip('积分可用于兑换优惠券，当前演示积分 3450。')} className="bg-surface-container-lowest p-md rounded-xl shadow-[0_4px_12px_rgba(171,53,0,0.03)] flex flex-col items-center justify-center text-center active:bg-surface-variant transition-colors cursor-pointer">
        ...
        <section className="bg-surface-container-lowest rounded-xl shadow-[0_4px_12px_rgba(171,53,0,0.03)] overflow-hidden">
          ...
          <div className="grid grid-cols-4 gap-sm p-sm">
            <button onClick={goAddress} className="flex flex-col items-center gap-sm p-sm hover:bg-surface-container transition-colors rounded-lg cursor-pointer active:scale-[0.96]">
            ...
            <button onClick={goReviews} className="flex flex-col items-center gap-sm p-sm hover:bg-surface-container transition-colors rounded-lg cursor-pointer active:scale-[0.96]">
            ...
            <button onClick={() => tip('我的收藏功能开发中')} className="flex flex-col items-center gap-sm p-sm hover:bg-surface-container transition-colors rounded-lg cursor-pointer active:scale-[0.96]">
            ...
            <button onClick={() => tip('客服电话：400-800-2026')} className="flex flex-col items-center gap-sm p-sm hover:bg-surface-container transition-colors rounded-lg cursor-pointer active:scale-[0.96]">
        ...
        <section onClick={() => tip('邀请码：CY2026，邀请好友下单可得模拟现金券。')} className="bg-gradient-to-r from-primary-container to-primary-fixed rounded-xl p-md flex items-center justify-between shadow-sm cursor-pointer active:scale-[0.98] transition-transform">
          <div>
          ...
          <button onClick={(event) => { event.stopPropagation(); tip('邀请码：CY2026'); }} className="bg-surface text-primary font-label-md text-label-md font-bold px-4 py-2 rounded-full shadow-sm hover:bg-surface-bright transition-colors">去邀请</button>
        </section>
        ...
        <section className="bg-surface-container-lowest rounded-xl shadow-[0_4px_12px_rgba(171,53,0,0.03)] overflow-hidden flex flex-col mb-xl">
          <button onClick={() => tip('系统设置：演示版暂支持消息与隐私偏好预览。')} className="w-full flex items-center justify-between p-md border-b border-surface-variant hover:bg-surface-container transition-colors cursor-pointer active:bg-surface-variant">
          ...
          <button onClick={() => tip('帮助与反馈：可联系 400-800-2026。')} className="w-full flex items-center justify-between p-md border-b border-surface-variant hover:bg-surface-container transition-colors cursor-pointer active:bg-surface-variant">
            <div className="flex items-center gap-md">
          ...
          <button onClick={onLogout} className="flex items-center justify-center p-md hover:bg-error-container transition-colors cursor-pointer active:bg-error/10 group">
